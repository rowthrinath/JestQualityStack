...
test("launch browser and visit website", async () => {
  ...
  await page.screenshot({
    path: "./src/test/screenshots/landingpage.jpg",
    fullpage: true,
    type: "jpeg",
  });
  await page.waitForSelector(
    "#root > div > div:nth-child(1) > header > nav > div.toolbar_toggle_button > button > div:nth-child(1)",
    { visible: true }
  );
  await page.click(
    "#root > div > div:nth-child(1) > header > nav > div.toolbar_toggle_button > button > div:nth-child(1)"
  ...
  await page.waitForSelector(
    "#root > div > div:nth-child(1) > nav > ul > li:nth-child(1) > a",
    { visible: true }
  );
});
